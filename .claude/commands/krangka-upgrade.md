...
1. **Read the krangka-upgrade skill**
   ...
   Load `.claude/skills/krangka-upgrade/SKILL.md` and follow its Upgrade Workflow.
...
3. **Discover available versions**
   ...
   - List files in `.claude/skills/krangka-upgrade/references/`
...
5. **Apply each version (in order)**
   ...
   - Read `.claude/skills/krangka-upgrade/references/vX.Y.Z.md`
