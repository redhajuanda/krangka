        ...
        "/todos": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Optional filter for done status",
                        "name": "is_done",
                        "in": "query"
                    },
                    {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.ReqCreateTodo"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.ResCreateTodo"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.ResGetTodoByID"
                                        }
                                    }
                                }
                            ]
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.ReqUpdateTodo"
                        }
                    }
                ],
                "responses": {
